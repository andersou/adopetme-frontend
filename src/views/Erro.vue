...
<!--Dust particle end--->
  <div class="error__content">
    <div class="error__message message">
      <h1 class="message__title">Página não encontrada!</h1>
      <h1 class="message__title">
        <figure class="adopetme-figure image">
        <img src="../assets/Dinosaurs-bro.svg" alt="" srcset="" />
        </figure>
      </h1>
      <p class="message__text">Tem alguma coisa errada aqui... Isso não parece um pet...</p>
    </div>
  </div>
