<template>
  <main>
    <div id="app">
      ...
      <div class="column"></div> <!-- Sei que não é a forma certa de adicionar esse espaço, mas tbm n sei qual a forma certa -->
      <footer class="footer pb-0 has-background-light"> <!-- E aqui  não tava sabendo como setar uma cor qualquer na classe footer do Bulma, então deixei cinza -->
      <div class="columns">
            ...
            <figure class="image adopetme-social-media">
              <div class="columns">
                <div class="column">
                  ...
                  <img src="../src/assets/AdoPetMe_Facebook.png" alt="" srcset="" />
                  </a>
                </div>
                <div class="column">
                  <a href="https://www.twitter.com/">
                  <img src="../src/assets/AdoPetMe_Twitter.png" alt="" srcset="" />
                  </a>
                </div>
                <div class="column">
                  <a href="https://www.instagram.com/">
                  <img src="../src/assets/AdoPetMe_Instagram.png" alt="" srcset="" />
                  </a>
                </div>
                <div class="column">
                  <a href="https://www.youtube.com/">
                  <img src="../src/assets/AdoPetMe_Youtube.png" alt="" srcset="" />
                  </a>
                </div>
              </div>
            </figure>
      ...
      <hr style="height:2px;border-width:0;color:gray;background-color:gray;margin:1.5rem 0 0.5rem 0.5rem">
      <span class="logo-adopetme ">Adopetme</span>
      </footer>
      <!-- 
       -->
